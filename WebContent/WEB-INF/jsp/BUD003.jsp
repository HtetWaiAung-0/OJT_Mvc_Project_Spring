...
<body>
	...
	<div class="container">
		...
		<div class="main_contents">
			<div id="sub_content">
				<form:form action="courseAdd" method="post" modelAttribute="cBean">
					...
					<div class="row mb-4">
						...
						<form:label path="courseId" class="col-md-2 col-form-label">ID</form:label>
						<div class="col-md-4">


							<form:input type="text" class="form-control" id="id" path="courseId" readonly="true" />
						</div>
					</div>
					...
					<div class="row mb-4">
						...
						<form:label path="courseName" class="col-md-2 col-form-label">Name</form:label>
						<div class="col-md-4">
